...
if CURRENT_PYTHON < REQUIRED_PYTHON:
    sys.stderr.write(
        "This version of CjkCMS requires Python {}.{} or above - you are running {}.{}\n".format(
...
class CreateProject(TemplateCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--sitename",
            help='Human readable name of your website or brand, e.g. "Nano Corp Inc."',
        )
        parser.add_argument(
            "--domain",
            help='Domain that will be used for your website in production, e.g. "www.nanocorp.com"',
        )
    ...
    def handle(self, **options):
        ...
        cms_path = os.path.dirname(cjkcms.__file__)
        ...
        # Check if provided template is built-in to the cms,
        ...
        # Set options
        message = "Creating a CjkCMS project called %(project_name)s"
        ...
        options["cjkcms_version"] = cjkcms.VERSION  # type: ignore
...
"""
        print(nextsteps % {"directory": target or project_name})
