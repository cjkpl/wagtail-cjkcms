...
class CjkcmsStreamField(StreamField):
    """
    ...
    migration problems (most commonly: a client overrides CJKCMS_FRONTEND_*,
    ...
    Client sites built with the CMS may use this in place of the Wagtail
    StreamField, in order to avoid huge migration files. However, note that it
    will not be possible to mine data out of a CjkcmsStreamField during a
    ...
    def deconstruct(self):
        ...
        blocks are nested within the StreamField::
            ...
            ("body", cjkcms.fields.CjkcmsStreamField([]))
